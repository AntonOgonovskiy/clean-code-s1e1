...
let createNewTaskElement = function (taskString) {
  ...
  editButton.className = "list__edit-task-button";
...
let editTask = function () {
  ...
  let editBtn = listItem.querySelector(".list__edit-task-button");
...
let bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  let editButton = taskListItem.querySelector(".list__edit-task-button");
  let deleteButton = taskListItem.querySelector(".list__delete-task-button");
